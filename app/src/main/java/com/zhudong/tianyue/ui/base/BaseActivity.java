...
import com.zhudong.tianyue.ui.inter.IBase;
import com.zhudong.tianyue.utils.DialogHelper;
import com.zhudong.tianyue.utils.StatusBarUtil;
import com.zhudong.tianyue.utils.T;
import com.zhudong.tianyue.widget.MultiStateView;
import com.zhudong.tianyue.widget.SimpleMultiStateView;
...
public abstract class BaseActivity<T1 extends BaseContract.BasePresenter> extends SupportActivity implements IBase, BaseContract.BaseView, BGASwipeBackHelper.Delegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mSimpleMultiStateView!=null){
            Log.e("tag", "mSimpleMultiStateView::"+mSimpleMultiStateView.getChildCount());
        }
    }
