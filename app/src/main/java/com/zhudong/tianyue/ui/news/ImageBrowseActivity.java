...
import com.zhudong.tianyue.widget.HackyViewPager;
import com.zhudong.tianyue.widget.MyScrollView;
import com.zhudong.tianyue.widget.SwipeBackLayout;
...
public class ImageBrowseActivity extends BaseActivity<ArticleReadPresenter> implements ArticleReadContract.View {
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Log.e("tag", "instantiateItem:"+slidesBeanList.get(position).getImage());
